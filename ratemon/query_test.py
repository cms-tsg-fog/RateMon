...
hltsuperauth = OIDCAuth(
    client_id = cfg['token_info']['token_name'],
    client_secret = cfg['token_info']['token_secret'],
...
def thresholds_query():
    url = "https://hltexpert-tsg-fog.app.cern.ch/api/v0/thresholds"
    print(url)
