...
def readURL(url):
    import http.cookiejar, urllib.request, urllib.error, urllib.parse,os,sys
    ...
    cj = http.cookiejar.MozillaCookieJar(cookieLocation)
    cj.load()
    opener = urllib.request.build_opener(urllib.request.HTTPCookieProcessor(cj))
    return opener.open(urllib.request.Request(url)).read()
